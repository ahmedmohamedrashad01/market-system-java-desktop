...
public class Purchases_Jornal_Local_PapersController implements Initializable {
    ...
    void btnSaveAction(ActionEvent event) {
     if(txtName.getText().trim().isEmpty()){
              ...
              Alert a = new Alert(Alert.AlertType.ERROR);
                ...
                DB d = new DB();
               // d.PurchasesLocalJornalPapers(color, qty, txtMobile.getText(), txtDate.getValue(), price);
