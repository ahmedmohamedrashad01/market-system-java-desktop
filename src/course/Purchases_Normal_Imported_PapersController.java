...
public class Purchases_Normal_Imported_PapersController implements Initializable {
    ...
    void btnSaveAction(ActionEvent event) {
       if(txtName.getText().trim().isEmpty()){
            ...
            DB d = new DB();
          //  d.PurchasesNormalImportedPapers(color, qty, txtMobile.getText(), txtDate.getValue(), price);
