...
import static course.Purchases_normal_white_papersController.color;
import java.net.URL;
...
public class Sales_normal_white_papersController implements Initializable {
    ...
    void btnSaveAction(ActionEvent event) {
        if (txtName.getText().isEmpty()) {
            ...
            new Alert(Alert.AlertType.ERROR,"من فضلك اختر مقاس المنتج").showAndWait();
            ...
            DB d = new DB();
            d.SalesOfNewPapers(txtName.getText(),color,size,qty, txtMobile.getText(), txtDate.getValue(), price,user);
            txtName.clear();
            txtQty.clear();
            txtPrice.clear();
        }
